...
const MOCK_ORIGINAL = [
  ...
  { id: 29, q: "Câu 29: Ai là 'Cha đẻ' của thuyết tương đối?", a: "D. Albert Einstein", explanation: "Albert Einstein nổi tiếng với thuyết tương đối rộng và hẹp." },
...
const MOCK_VARIATION = [
  ...
  { id: 10, q: "Câu 10: Biệt danh 'Thành phố Hoa Phượng Đỏ' dùng để chỉ thành phố nào?", a: "B. Hải Phòng", explanation: "Cây hoa phượng đỏ là loài hoa biểu tượng gắn liền với vẻ đẹp của Hải Phòng." },
